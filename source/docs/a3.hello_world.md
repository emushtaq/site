...
`println!` prints text to the console and its *!* indicates that it’s a [macro](https://doc.rust-lang.org/1.30.0/book/second-edition/appendix-04-macros.html) rather than a function.
